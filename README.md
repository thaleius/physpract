# Description
This is a package primarily created to help with writing the protocols for the physical practicals at the TU Berlin, created by a student, who was tired of writing the long equations to show the calculation of uncertainties. To calculate the uncertainties, the package uses the linear error propagation.
